A set of target language bindings that allows developers to interface with the \hyperlink{class_g_a_u_s_s}{G\-A\-U\-S\-S} Engine.
...
\begin{TabularC}{2}
\hline
\rowcolor{lightgray}{\bf What You're Used To }&{\bf How Python does it}\\\cline{1-2}
{\ttfamily make} &{\ttfamily python setup.\-py build\-\_\-ext -\/i} \\\cline{1-2}
