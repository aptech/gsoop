\hypertarget{class_workspace_manager}{}\doxysection{Workspace\+Manager Class Reference}
\label{class_workspace_manager}\index{WorkspaceManager@{WorkspaceManager}}
...
\mbox{\hyperlink{class_g_e_workspace}{GEWorkspace}} $\ast$ {\bfseries get\+Current} () const
\item 
...
bool {\bfseries set\+Current} (\mbox{\hyperlink{class_g_e_workspace}{GEWorkspace}} $\ast$wh)
\item 
...
\mbox{\hyperlink{class_g_e_workspace}{GEWorkspace}} $\ast$ {\bfseries get\+Workspace} (const std\+::string \&) const
\item 
...
bool {\bfseries destroy} (\mbox{\hyperlink{class_g_e_workspace}{GEWorkspace}} $\ast$)
\item 
...
\mbox{\hyperlink{class_g_e_workspace}{GEWorkspace}} $\ast$ {\bfseries create} (const std\+::string \&)
\item 
...
bool {\bfseries contains} (\mbox{\hyperlink{class_g_e_workspace}{GEWorkspace}} $\ast$) const
\item 
...
bool {\bfseries is\+Valid\+Workspace} (\mbox{\hyperlink{class_g_e_workspace}{GEWorkspace}} $\ast$) const
