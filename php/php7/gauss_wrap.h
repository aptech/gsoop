...
#ifndef SWIG_GE_WRAP_H_
#define SWIG_GE_WRAP_H_

class SwigDirector_IGEProgramOutput : public IGEProgramOutput, public Swig::Director {

public:
    SwigDirector_IGEProgramOutput(zval *self);
...
public:
    SwigDirector_IGEProgramFlushOutput(zval *self);
    virtual void invoke();
...
public:
    SwigDirector_IGEProgramInputString(zval *self);
...
public:
    SwigDirector_IGEProgramInputChar(zval *self);
    virtual int invoke();
...
public:
    SwigDirector_IGEProgramInputCheck(zval *self);
    virtual bool invoke();
